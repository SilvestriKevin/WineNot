...
if(!empty($_SESSION['id'])) $stampa = "<li><a title='Area Riservata' class='' href='./php/admin.php' tabindex='' acceskey=''>Area Riservata</a></li><li><a title='Esci dall'Area Riservata class='' href='./index.php?esci=1' tabindex='' accesskey='q'>Esci</a></li>";
