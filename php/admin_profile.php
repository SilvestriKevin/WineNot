...
if (mysqli_num_rows($result) != 0) {
    $dati .= '<ul>
                <li><label>Username</label></li><li><input type="text" maxlength="100" name="username" id=""
                title="username" value="' . $row['username'] . '"/></li>
                <li><label>Nome</label></li><li><input type="text" maxlength="100" name="nome" id="" title="nome"
                value="' . $row['nome'] . '"/></li>
                <li><label>Email</label></li><li><input type="text" maxlength="100" name="email" id="" title="email"
                value="' . $row['email'] . '"/></li>
                <li><label>Password attuale*</label></li><li><input type="password" maxlength="100" name="actual_password"
                id="" title="password attuale" value=""/></li>
                <li><label>Password nuova*</label></li><li><input type="password" maxlength="100" name="new_password" id=""
