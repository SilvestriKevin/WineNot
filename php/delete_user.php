...
//se è settato solo $_GET['users'] allora mostro la richiesta di conferma per l'eliminazione
    ...
    $dati.='<div class="select_admin_buttons"><input type="submit" class="admin_button" name="cancel" id="cancel" value="Annulla Eliminazione" onclick="goBackWines()" tabindex="7"/>';
