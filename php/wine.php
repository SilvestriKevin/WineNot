...
//senza passare per la pagina dei vini o delle annate, allora setto $indietro con la pagina iniziale
else {
    $indietro = '../index.html';
}
...
if (!empty($_GET['id_wine'])) {
    ...
    $sql = 'SELECT vini.* FROM vini WHERE id_wine="' . htmlentities($_GET['id_wine'], ENT_QUOTES) . '"';
