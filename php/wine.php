...
if(!empty($_GET["id_wine"])){
    ...
    if(mysqli_num_rows($result)!=0){
        ...
        $immagine.='<img id="wine_img" alt="Immagine vino '.$row["nome"].'" src="../img/'.$row["id_wine"].'.png" />';
    ...
    else $informazioni.= '<li><h2>Non sono presenti informazioni su questo vino.</h2></li>';
}
else {
